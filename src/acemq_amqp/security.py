...
unusable against anything real. Java, Go, Ruby and .NET all do the same, and all
five give the same way out — say so deliberately, with
...
#:
#: The same string in Java, Go, Ruby and .NET, byte for byte, so a certificate
#: generated by any of the five libraries is refused by all of them. That is the
