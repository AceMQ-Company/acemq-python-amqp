...
NAV='<nav class="top">
  ...
  <div class="group">
    ...
    <div class="menu">
      ...
      <a href="observability.html">Metrics, health and tracing</a>
...
for f in docs/*.md; do
  ...
  # "AceMQ for Python — AceMQ for Python" in the browser tab.
  if [ "$title" = "AceMQ for Python" ]; then
    pagetitle="$title"
  else
    pagetitle="$title — AceMQ for Python"
  fi
